Feature: Tag Good Internal Tags

  @user1 @web
  Scenario: Tag Good Internal Tags
    Given I set scenario "tagGoodInternalTags"
    ...
    Then I click on element having xpath "//button[@class='gh-btn ']//span"
